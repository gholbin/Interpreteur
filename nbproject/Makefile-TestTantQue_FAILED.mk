...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/testUnitaire/TantQueTest.o \
	${TESTDIR}/testUnitaire/TantQueTestRunner.o
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/testUnitaire/TantQueTest.o ${TESTDIR}/testUnitaire/TantQueTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `cppunit-config --libs`   


${TESTDIR}/testUnitaire/TantQueTest.o: testUnitaire/TantQueTest.cpp 
	${MKDIR} -p ${TESTDIR}/testUnitaire
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testUnitaire/TantQueTest.o testUnitaire/TantQueTest.cpp


${TESTDIR}/testUnitaire/TantQueTestRunner.o: testUnitaire/TantQueTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/testUnitaire
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testUnitaire/TantQueTestRunner.o testUnitaire/TantQueTestRunner.cpp
