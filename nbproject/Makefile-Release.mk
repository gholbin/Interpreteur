...
${TESTDIR}/testUnitaire/TantQueTest.o: testUnitaire/TantQueTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testUnitaire/TantQueTest.o testUnitaire/TantQueTest.cpp


${TESTDIR}/testUnitaire/TantQueTestRunner.o: testUnitaire/TantQueTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/testUnitaire
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testUnitaire/TantQueTestRunner.o testUnitaire/TantQueTestRunner.cpp
